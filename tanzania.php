...
$hero_image = "tanzania.jpg";
$cultural_insights = array(
"Customs" => array(
    "description" => "Tanzanian culture is rich in traditional customs and rituals. These include the Uhuru Torch Race, which symbolizes the country's freedom and unity, and the traditional Ngoma dance performances that highlight the diverse cultural heritage of Tanzania.",
    "foods" => array(
        "Ugali" => "A staple food made from maize flour, often served with stews or vegetables.",
        "Nyama Choma" => "Grilled meat, typically goat or beef, a popular dish in Tanzania.",
        "Mchicha" => "A traditional dish made from spinach or amaranth leaves, often cooked with coconut milk."
    )
),
"Cuisine" => array(
    "description" => "Tanzanian cuisine features a variety of local ingredients such as maize, coconut, and spices. Popular dishes include Wali wa Nazi (coconut rice) and Mshikaki (marinated meat skewers).",
    "foods" => array(
        "Wali wa Nazi" => "A flavorful rice dish cooked with coconut milk, often served with fish or meat.",
        "Mshikaki" => "Marinated meat skewers, typically grilled and served with vegetables.",
        "Vitumbua" => "Rice flour doughnuts, a popular snack or breakfast item in Tanzanian cuisine."
    )
),
"Clothing" => array(
    "description" => "The traditional attire of Tanzania includes the Kanga and Kitenge for women and the Maasai Shuka for men. These garments are known for their vibrant colors and intricate patterns, reflecting the country's rich textile traditions.",
    "traditional_items" => array(
        "Kanga" => "A colorful fabric worn by women, often featuring Swahili sayings and patterns.",
        "Kitenge" => "A brightly colored fabric used to make dresses and skirts, popular among Tanzanian women.",
        "Maasai Shuka" => "A traditional checkered cloth worn by the Maasai people, symbolizing their cultural identity."
    )
)
);
...
$tourist_attractions = array(
    array(
        ...
        "description" => "Serengeti National Park is one of Tanzania's most iconic wildlife reserves, famous for its vast savannahs and the Great Migration.",
        "full_description" => "Serengeti National Park, located in northern Tanzania, is known for its incredible biodiversity and as the site of the Great Migration. Each year, millions of wildebeest, zebras, and gazelles move across the park's vast savannahs, making it one of the most dramatic wildlife spectacles on Earth. The park is home to a diverse range of wildlife, including the Big Five (lion, leopard, elephant, buffalo, and rhino), making it a must-visit destination for safari enthusiasts.",
        "location" => "Northern Tanzania",
        "best_time_to_visit" => "June to October (dry season, during the migration)"
    ),
    array(
        "image" => "kilimanjaro.jpg",
        "title" => "Mount Kilimanjaro",
        "description" => "Mount Kilimanjaro is the highest peak in Africa, attracting climbers from around the world to summit its snow-capped peak.",
        "full_description" => "Standing at 5,895 meters (19,341 feet), Mount Kilimanjaro is the highest mountain in Africa and one of the world's most iconic climbs. Located in northeastern Tanzania, the mountain offers various trekking routes, from scenic forest paths to alpine deserts. The summit, Uhuru Peak, is one of the most sought-after destinations for adventurers. Kilimanjaro is also home to unique ecosystems, including rainforests and glaciers, making it a diverse and rewarding destination for both climbers and nature lovers.",
        "location" => "Northeastern Tanzania",
        "best_time_to_visit" => "January to March and June to October (dry season)"
    ),
    array(
        "image" => "stone_town.jpg",
        "title" => "Stone Town",
        "description" => "Stone Town, located on Zanzibar Island, is a UNESCO World Heritage Site known for its rich history, architecture, and culture.",
        "full_description" => "Stone Town, the historic center of Zanzibar City, is a UNESCO World Heritage Site with a blend of Arab, Persian, Indian, and European architectural influences. The town's narrow streets are lined with ancient buildings, including mosques, palaces, and markets, reflecting its diverse history as a trading hub. Visitors can explore historical sites such as the House of Wonders, the Old Fort, and the spice plantations, making it an essential cultural experience in Tanzania.",
...
$upcoming_events = array (
  ...
  array (
    ...
    'description' => 'The Mwaka Kogwa Festival in Zanzibar celebrates the Shirazi New Year with traditional music, dance, and the symbolic burning of huts.',
  ),
  1 => 
  array (
    'title' => 'Karibu Travel and Tourism Fair',
    'date' => 'October 1-5, 2024',
    'description' => 'Experience the diversity of Tanzanian crafts, textiles, and artisanal products at this extensive fair featuring exhibitors from all over East Africa.',
  ),
  2 => 
  array (
    'title' => 'Great Serengeti Race',
    'date' => 'November 10, 2024',
    'description' => 'Enjoy the exhilarating annual boat race on Lake Victoria.',
  ),
);
            ...
            <div class="cultural-insights">
                ...
                <div class="cultural-insights-grid">
                    <?php foreach ($cultural_insights as $title => $insight) { ?>
                        ...
                        <img src="images/tanzania_<?php echo strtolower(str_replace(' ', '_', $title)) . '.jpg'; ?>" alt="<?php echo $title; ?>" />
