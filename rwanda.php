...
$country_name = "Rwanda";
$hero_image = "rwanda.jpg";
$cultural_insights = array(
"Customs" => array(
    "description" => "Rwandan culture is rich in traditional customs and rituals. These include the Umuganura festival, which celebrates the first fruits of the harvest, and the Intore dance performances that showcase the country's vibrant cultural heritage.",
    "foods" => array(
...
"Cuisine" => array(
    "description" => "Rwandan cuisine is characterized by the use of local ingredients such as cassava, plantains, and beans. Popular dishes include Igisafuriya (a meat and vegetable stew) and Umutsima (a type of porridge).",
    "foods" => array(
        "Igisafuriya" => "A hearty meat and vegetable stew typically made with local spices and ingredients.",
        "Umutsima" => "A traditional porridge made from sorghum or maize flour.",
        "Akabenz" => "Fried pork, a popular dish in Rwandan cuisine."
    )
),
"Clothing" => array(
    "description" => "The traditional attire of Rwanda includes the Imishanana, a handcrafted woven garment worn by women, and the Umwitero, a traditional garment worn by men. These garments are a testament to the country's rich textile traditions.",
    "traditional_items" => array(
        "Imishanana" => "A traditional woven garment with intricate patterns, often worn by women during cultural ceremonies.",
        "Umwitero" => "A traditional garment worn by men, symbolizing cultural significance.",
...
$tourist_attractions = array(
    array(
        "image" => "genocide_memorial.jpg",
        "title" => "Kigali Genocide Memorial",
        "description" => "The Kigali Genocide Memorial is a site dedicated to the memory of those who lost their lives during the 1994 genocide in Rwanda.",
        "full_description" => "The Kigali Genocide Memorial is an important historical site in Rwanda, commemorating the victims of the 1994 genocide. It includes mass graves, exhibits, and educational programs that offer visitors an opportunity to learn about the events and the resilience of the Rwandan people. The memorial is located in the capital city of Kigali and serves as both a memorial and a museum, aiming to promote peace and unity.",
        "location" => "Kigali, Rwanda",
        "best_time_to_visit" => "June to September (dry season)"
    ),
    array(
        "image" => "volcanoes_park.jpg",
        "title" => "Volcanoes National Park",
        "description" => "Volcanoes National Park is famous for its mountain gorillas and stunning landscapes of volcanic mountains.",
        "full_description" => "Volcanoes National Park, located in the northwest of Rwanda, is one of the most famous wildlife destinations in Africa. It is home to the endangered mountain gorillas, and visitors can go on guided treks to observe these magnificent creatures in their natural habitat. The park is also known for its spectacular volcanic landscapes and offers numerous hiking trails for adventure enthusiasts.",
    ...
    array(
        "image" => "lake_kivu.jpg",
        "title" => "Lake Kivu",
        "description" => "Lake Kivu is one of Africa's Great Lakes, offering a tranquil retreat with beautiful beaches and water-based activities.",
        "full_description" => "Lake Kivu, located on the border between Rwanda and the Democratic Republic of the Congo, is one of Africa's Great Lakes. It is known for its clear waters and scenic surroundings, making it a popular destination for relaxation and outdoor activities. Visitors can enjoy boat tours, kayaking, and hiking along the lakeshore. The town of Gisenyi, on the Rwandan side of the lake, is a popular base for exploring the area.",
...
$upcoming_events = array (
  ...
  array (
    ...
    'description' => 'This festival features a blend of local and international music acts, promoting peace and unity through music.',
  ),
  1 => 
  array (
    'title' => 'Rwanda Film Festival',
    'date' => 'July 13-20, 2024',
    'description' => 'Known as Hillywood, this festival showcases Rwandan and international films, highlighting the region\'s growing film industry.',
  ),
  2 => 
  array (
    ...
    'title' => 'Kwibohora',
    'date' => 'April 10, 2025',
    'description' => 'Witness the thrilling annual liberation race of Rwanda, a celebration of Rwanda\'s resilience heritage.',
  ),
);
            ...
            <div class="cultural-insights">
                ...
                <div class="cultural-insights-grid">
                    <?php foreach ($cultural_insights as $title => $insight) { ?>
                        ...
                        <img src="images/rwanda_<?php echo strtolower(str_replace(' ', '_', $title)) . '.jpg'; ?>" alt="<?php echo $title; ?>" />
